...
public class RepastGUI extends SimpleModel{
	...
	public RepastGUI() {
		...
		h1.put(new Integer(1), "Regular expression (1)");
		h1.put(new Integer(2), "Finite automaton  (2)");
		h1.put(new Integer(3), "Turing Machine (3)");
		h1.put(new Integer(4), "Restricted (4)");
		h1.put(new Integer(5), "Reactive simple (5)");
		
		ListPropertyDescriptor pd = new ListPropertyDescriptor("Representation", h1);
		
		Hashtable<Integer, String> h2 = new Hashtable<Integer, String>();
		h2.put(new Integer(0), "Wright-Fisher process (0)");
		h2.put(new Integer(1), "Moran process (1)");
		...
		h3.put(new Integer(0), "No measures (0)");
		h3.put(new Integer(1), "Frequency dependent (1)");
		h3.put(new Integer(2), "Absolute (2)");
	...
	protected OpenSequenceGraph averagePayoff;
	...
	//long seed_ = 1300828204429L;
	//protected Long seed =  new Long(System.currentTimeMillis());
	protected Long seed =  null;
	//protected Long seed =  new Long(seed_);
	...
	protected int updateGraphsEvery = 5;
	...
	protected double	assortment = 0.0;
	...
	public void setup() {
		...
		averagePayoff = new OpenSequenceGraph("Average payoff", this);
		...
		this.registerMediaProducer("averagePayoff", averageFitness);
		averagePayoff.setYRange(0.0, 1.0);
		
		
		this.registerMediaProducer("measures", measures);
		measures.setYRange(0.0, 1.0);
	...
	protected void buildRecorder() {
		if (StringUtils.isEmpty(this.fileName)) {
			...
			recorder.createNumericDataSource("averagePayoff", this, "getTabAveragePayoff");
			recorder.createNumericDataSource("averagePayOffNoComplexity", this, "getTabAveragePayoffNoComplexity");
	...
	protected Sequence averagePayoff() {

		class averagePayoff implements DataSource, Sequence {

			public Object execute() {
				return new Double(getSValue());
			}
			public double getSValue() {
				return  tabAveragePayoff;
			}
		}
	...
	protected void buildDisplay() {
		...
		averagePayoff.addSequence("Average payoff", this.averagePayoff(), Color.red);
		if (computeComplexity) {
	...
	public String getName() {
		return "Evolution in repeated games!!";
	}
	...
	public String[] getInitParam() {
		String[] initParams = {"evolution", "representation","populationSize", "seed", "mutationProbability", "continuationProbability", "complexityCost", "R", "P", "S", "T", "UpdateGraphsEvery", "FileName", "Measure", "precisionMeasures", "computeComplexity", "W", "Assortment", "perceptionMistakeProbability", "implementationMistakeProbability"};
		return initParams;
	}
	public static void main(String[] args) {
			SimInit init = new SimInit();
			RepastGUI model = new RepastGUI();
	...
	protected double tabAveragePayoff;
	protected double tabAveragePayoffNoComplexity;
	...
	public void computeValues(){
		try {
			...
			this.tabAveragePayoff = operations.getAveragePayoff();
			//RepastGUI.appendToFile("average.txt", new Double(tabAveragePayoff).toString());
			this.tabAveragePayoffNoComplexity = operations.getAveragePayoffNoComplexity();
	...
	public OpenSequenceGraph getAveragePayoff() {
		return averagePayoff;
	}
	public void setAveragePayoff(OpenSequenceGraph averagePayoff) {
		this.averagePayoff = averagePayoff;
	}
	public double getTabAveragePayoff() {
		return tabAveragePayoff;
	}
	public void setTabAveragePayoff(double tabAveragePayoff) {
		this.tabAveragePayoff = tabAveragePayoff;
	}
	public double getTabAveragePayoffNoComplexity() {
		return tabAveragePayoffNoComplexity;
	}
	public void setTabAveragePayoffNoComplexity(double tabAveragePayoffNoComplexity) {
		this.tabAveragePayoffNoComplexity = tabAveragePayoffNoComplexity;
	}
